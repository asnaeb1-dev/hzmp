...
public class CentralQueue extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "centralqueue.db";
    private static final int DATABASE_VERSION = 1;
    public static  final String TABLE_NAME = "CENTRAL_QUEUE";
    ...
    public CentralQueue(Context context ) {
    ...
    public boolean deleteThisDatabase(Context context)
    {
